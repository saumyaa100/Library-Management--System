    ...
    return (
        <>
            <div className={`${classes.pageHeader} ${classes.mb2}`}>
                ...
                {isAdmin && (
                    <Button variant="contained" color="primary" component={RouterLink} to="/admin/books/add" style={{backgroundColor:"green"}}>
                        Add Book
                    </Button>
                )}
            </div>
                        ...
                        <Modal open={openModal} onClose={(e) => setOpenModal(false)}>
                            <Card className={classes.conf_modal}>
                                ...
                                <CardActions className={classes.conf_modal_actions}>
                                    <Button variant="contained" onClick={() => setOpenModal(false)} style={{backgroundColor:"gray"}} >
                                        Cancel
                                    </Button>
                                    <Button variant="contained" color="secondary" onClick={deleteBook} style={{backgroundColor:"green"}}>
                                        Delete
                                    </Button>
                                </CardActions>
                            </Card>
