            ...
            <div className={classes.wrapper}>
                ...
                <Card>
                    <Tabs
                        ...
                        centered
                    >
                        <Tab label="Book Details" tabIndex={0} style={{color:"green"}}/>
                        <Tab label="Price History" tabIndex={1} style={{color:"green"}} />
                        <Tab label="Quantity History" tabIndex={2} style={{color:"green"}}/>
                    </Tabs>
                    ...
                    <TabPanel value={openTab} index={1}>
                        <CardContent>
                            {book && book.priceHistory.length > 0 ? (
                                <HighchartsReact highcharts={Highcharts} options={chartOptions} style={{color:"green"}} />
                            ) : (
                        ...
                        <div className={classes.btnContainer}>
                            {isAdmin ? (
                                ...
                                <>
                                    <Button
                                    style={{
        backgroundColor: book && user && !book.borrowedBy.includes(user._id) ? "green" : "gray",
        color: "white",
    }}
                                        variant="contained"
                                        onClick={borrowBook}
                                    ...
                                    <Button
    style={{
        backgroundColor: book && user && !book.borrowedBy.includes(user._id) ? "gray" : "green",
        color: "white",
    }}
    variant="contained"
    onClick={returnBook}
...
>
    Return
                            ...
                            <Button type="submit" variant="text" color="primary" onClick={() => navigate(-1)} style={{color:"green"}}>
                                Go Back
                            </Button>
                        </div>
                    </CardActions>
